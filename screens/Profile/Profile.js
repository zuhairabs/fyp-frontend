...
const Profile = ({navigation}) => {
  ...
  useEffect(() => {
    ...
    else getUserFromAsyncStorage().then((storedUser) => setUser(storedUser));
  }, [state.user]);
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              ...
              <View style={styles.buttonIcon}>
                <Image
                  source={require('./menu-icons/portrait-black-48dp.png')}
            ...
            <TouchableOpacity
              ...
              <View style={styles.buttonIcon}>
                <Image
                  source={require('./menu-icons/favorite_border-black-48dp.png')}
                  style={styles.buttonIconImage}
                />
              </View>
